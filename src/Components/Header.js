...
const Header = ({ data }) => {
  ...
  return (
    <>
      <div
        class='bg-[url("https://wallpapercave.com/wp/wp6350571.jpg")] h-screen w-full bg-cover bg-center'
        id="Home">
        <header id="home">
          <nav id="nav-wrap">
              ...
              <div class="flex flex-col justify-center items-center ">
                <ul  >
                  <a className="smoothscroll" href="#home"
                    class="py-2 pr-4 pl-3 text-black-700 rounded hover:bg-gray-100  font-semibold ">Home</a>
                  <a className="smoothscroll" href="#about"
                    class=" py-2 pr-4 pl-3 text-black-700 rounded hover:bg-gray-100  font-semibold">About</a>
                  <a className="smoothscroll" href="#resume"
                    class=" py-2 pr-4 pl-3 text-black-700 rounded hover:bg-gray-100  font-semibold">Resume</a>
                  <a className="smoothscroll" href="#portfolio" 
                    class=" py-2 pr-4 pl-3 text-black-700 rounded hover:bg-gray-100  font-semibold">Portfolio</a>
                  <a className="smoothscroll" href="#contact"
                    class=" py-2 pr-4 pl-3 text-black-700 rounded hover:bg-gray-100  font-semibold">Contact</a>
                </ul>
              </div>
          ...
          <div class="flex mt-4 space-x-10 sm:justify-center sm:mt-0 ">
            <a href="https://www.facebook.com/Nandhini Ukesh" class="text-blue-500 hover:text-blue-900 dark:hover:text-blue">
            ...
            <a href="http://www.instagram.com/in/nandhu_ukesh" class="text-pink-500 hover:text-pink-900 dark:hover:text-pink">
            ...
            <a href="https://github.com/Nandhini1997-web" class="text-black-500 hover:text-black-900 dark:hover:text-black">
            ...
            <a href="https://twitter.com/?lang=en-in" class="text-blue-500 hover:text-blue-900 dark:hover:text-blue">
